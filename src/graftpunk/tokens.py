...
_TOKEN_NAV_TIMEOUT = 30  # seconds — max time for navigating to a token page + extracting
...
async def extract_tokens_from_tab(
    ...
    for page_url, token_group in by_url.items():
        ...
        try:
            ...
            LOG.warning("login_token_extraction_timeout", url=url, timeout=_TOKEN_NAV_TIMEOUT)
            continue
